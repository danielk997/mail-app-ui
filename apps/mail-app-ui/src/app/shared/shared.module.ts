...
@NgModule({
  declarations: [ActionBarComponent, FormBaseComponent, FormFieldDirective, FormSubmitButtonDirective, TemplateContextTypeDirective, StartCasePipe],
  imports: [CommonModule, HttpClientModule, ReactiveFormsModule, ...MATERIALS],
  exports: [...MATERIALS, ActionBarComponent, FormFieldDirective, FormSubmitButtonDirective, FormBaseComponent],
})
